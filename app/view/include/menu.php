        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="<?= BASEURL . '/controller/QuestaoController.php?action=list' ?>">Questões</a>
                    <a class="dropdown-item" href="<?= BASEURL . '/controller/QuizController.php?action=list' ?>">Quiz</a>
                </div>
            </li>
