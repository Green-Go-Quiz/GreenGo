    ...
    <div class="container">
        <div id="sobre">
            ...
            <p> É o resultado dos avanços de um projeto de extensão denominado <b>Green Go: Jogo Educacional Sobre a
                ...
                na integração na comunidade local entre si e com seu meio.<br>
                Atendendo a demanda do aprendizado dos jogadores, será desenvolvido neste módulo a implementação do quiz, um sistema de perguntas relacionados com as propriedades das espécies de plantas presentes ao longo das zonas e registradas no banco. A cada pergunta respondida corretamente, serão adquiridos pontos que virão a ser somados aos pontos de identificação ao final do percurso. 
O quiz funcionará com um sistema de perguntas de alternativas que poderá ser editado pelo administrador e pelo professor, podendo este criar novas perguntas ou até mesmo selecionar quizzes por tipos de espécies ou espécies aleatórias. O acesso às perguntas cadastradas com suas respectivas alternativas serão disponibilizadas em uma grade, com opção de edição e visualização apenas aos administradores e professores.
            ...
            <p>
            Propõe-se a elaboração de um sistema web voltado à educação botânica, configurado sob a forma de um questionário, composto por perguntas e respostas no formato de quiz. Este sistema visa contribuir significativamente para o aprendizado dinâmico da flora pertinente ao Instituto Federal do Paraná (IFPR).

O propósito primordial é fornecer suporte educativo ao oferecer um meio interativo de aprendizagem por meio do quiz. Essa abordagem busca promover o engajamento dos usuários, facilitando a assimilação e retenção de conhecimento relacionado à botânica específica do âmbito do IFPR.

Ademais, pretende-se estabelecer e manter um banco de dados amplo e constantemente atualizado. Este banco de dados conterá perguntas e respostas pertinentes ao conteúdo botânico, abarcando um espectro diversificado de informações relevantes ao contexto educacional proposto.
            </p>
        </div>
